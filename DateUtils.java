...
public class DateUtils {
    ...
    public static String str2Date(String dateString) {
        try {
            dateString = dateString.split(Pattern.quote("(中国标准时间)"))[0].replace("GMT+0800", "GMT+08:00");
            ...
            throw new RuntimeException("时间转化格式错误" + "[dateString=" + dateString + "]" + "[FORMAT_STRING=" + "yyyy-MM" + "]");
        }
    }
